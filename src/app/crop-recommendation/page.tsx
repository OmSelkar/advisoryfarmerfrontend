...
const translations = {
  english: {
    ...
    description:
      "Tell us about your farm, and we'll provide the best crop recommendations tailored to your needs",
    ...
    workPreferenceQuestion:
      "Do you prefer low-maintenance or high-maintenance crops?",
    ...
    landSizeOptions: [
      ...
      },
      {
        value: "10-plus-acres",
        label: "10+ acres",
        icon: <Globe className="w-8 h-8 text-green-800" />,
      },
    ],
    waterSourceOptions: [
      {
        value: "rainwater",
        label: "Rainwater only",
    ...
    growthPreferenceOptions: [
      {
        value: "quickly",
        label: "Quick (3-6 months)",
        icon: <Timer className="w-8 h-8 text-orange-500" />,
      },
      {
        value: "slowly",
        label: "Slow (1+ years)",
        icon: <Turtle className="w-8 h-8 text-orange-600" />,
      },
      {
        value: "both-growth",
        label: "Both types",
    ...
    budgetOptions: [
      {
        value: "low",
        label: "Low budget (₹10,000-25,000)",
        icon: <Coins className="w-8 h-8 text-yellow-500" />,
      },
      {
        value: "medium",
        label: "Medium budget (₹25,000-50,000)",
        icon: <Banknote className="w-8 h-8 text-yellow-600" />,
      },
      {
        value: "high",
        label: "High budget (₹50,000+)",
        icon: <TrendingUp className="w-8 h-8 text-yellow-700" />,
      },
    ],
    workPreferenceOptions: [
      ...
      },
      {
        value: "no-preference",
        label: "No preference",
        icon: <Scale className="w-8 h-8 text-indigo-700" />,
      },
    ],
    equipmentOptions: [
      {
        value: "Tractor",
        label: "Tractor",
        icon: <Tractor className="w-8 h-8 text-red-500" />,
      },
      {
        value: "Plough / Tiller",
        label: "Plough/Tiller",
      ...
      },
      {
        value: "Harvester",
        label: "Harvester",
        icon: <Wheat className="w-8 h-8 text-red-700" />,
      },
      {
        value: "No machinery",
        label: "No machinery",
  ...
  hindi: {
    ...
    description:
      "हमें अपनी खेती के बारे में बताएं, हम आपकी आवश्यकताओं के अनुसार सबसे अच्छी फसल की सिफारिश करेंगे",
    ...
    waterSourceOptions: [
      {
        value: "rainwater",
        label: "केवल बारिश का पानी",
        icon: <Droplets className="w-8 h-8 text-blue-400" />,
      },
      {
        value: "irrigation",
        label: "सिंचाई व्यवस्था",
        icon: <Zap className="w-8 h-8 text-blue-600" />,
      },
      {
        value: "mix",
    ...
    budgetOptions: [
      {
        value: "low",
        label: "कम बजट (₹10,000-25,000)",
        icon: <Coins className="w-8 h-8 text-yellow-500" />,
      },
      {
        value: "medium",
        label: "मध्यम बजट (₹25,000-50,000)",
        icon: <Banknote className="w-8 h-8 text-yellow-600" />,
      },
      {
        value: "high",
        label: "उच्च बजट (₹50,000+)",
        icon: <TrendingUp className="w-8 h-8 text-yellow-700" />,
      },
    ],
    workPreferenceOptions: [
  ...
  malayalam: {
    ...
    description:
      "നിങ്ങളുടെ കൃഷിയെക്കുറിച്ച് പറയൂ, ഞങ്ങൾ മികച്ച വിള ശുപാർശകൾ നൽകാം",
    ...
    waterSourceOptions: [
      {
        value: "rainwater",
        label: "മഴവെള്ളം മാത്രം",
        icon: <Droplets className="w-8 h-8 text-blue-400" />,
      },
      {
        value: "irrigation",
        label: "ജലസേചന സംവിധാനം",
        icon: <Zap className="w-8 h-8 text-blue-600" />,
      },
      {
        value: "mix",
    ...
    growthPreferenceOptions: [
      {
        value: "quickly",
        label: "വേഗത്തിൽ (3-6 മാസം)",
        icon: <Timer className="w-8 h-8 text-orange-500" />,
      },
      {
        value: "slowly",
        label: "പതുക്കെ (1+ വർഷം)",
        icon: <Turtle className="w-8 h-8 text-orange-600" />,
      },
      {
        value: "both-growth",
    ...
    budgetOptions: [
      {
        value: "low",
        label: "കുറച്ച് (₹10,000-25,000)",
        icon: <Coins className="w-8 h-8 text-yellow-500" />,
      },
      {
        value: "medium",
        label: "ഇടത്തരം (₹25,000-50,000)",
        icon: <Banknote className="w-8 h-8 text-yellow-600" />,
      },
      {
        value: "high",
    ...
    equipmentOptions: [
      ...
      {
        value: "Plough / Tiller",
        label: "കലപ്പ / കുഴിയന്ത്രം",
        icon: <Wrench className="w-8 h-8 text-red-600" />,
      },
      {
        value: "Harvester",
        label: "വിളവെടുപ്പ് യന്ത്രം",
        icon: <Wheat className="w-8 h-8 text-red-700" />,
      },
      {
        value: "No machinery",
        label: "യന്ത്രങ്ങൾ ഇല്ല",
        icon: <AlertCircle className="w-8 h-8 text-gray-500" />,
      },
    ],
    electricityOptions: [
      {
        value: "yes",
        label: "ഉണ്ട്, നല്ല സപ്ലൈ",
        icon: <Battery className="w-8 h-8 text-green-500" />,
      },
      {
        value: "intermittent",
        label: "ചിലപ്പോൾ മാത്രം",
        icon: <Zap className="w-8 h-8 text-yellow-500" />,
      },
      {
        value: "no",
    ...
    riskToleranceOptions: [
      {
        value: "low",
        label: "കുറച്ച് റിസ്ക്",
        icon: <Shield className="w-8 h-8 text-blue-500" />,
      },
      {
        value: "medium",
        label: "ഇടത്തരം റിസ്ക്",
        icon: <Scale className="w-8 h-8 text-yellow-500" />,
      },
      {
        value: "high",
    ...
    placeholders: {
      ...
      additionalInfo:
        "ഉദാഹരണം: കുടുംബത്തിന് നേരിട്ട് കഴിക്കാൻ പറ്റുന്ന വിള വേണം",
    },
  },
};
  ...
  const cropOptions = [
    {
      ...
      category: "Tree Crop",
      image:
        "https://images.unsplash.com/photo-1565598484066-49b0b7c7e0da?w=200&h=200&fit=crop&crop=center",
    },
    {
      value: "rubber",
      label: "Rubber",
      category: "Tree Crop",
      image:
        "https://images.unsplash.com/photo-1611273426858-450d8e3c9fce?w=200&h=200&fit=crop&crop=center",
    },
    {
      value: "tea",
      label: "Tea",
    ...
    },
    {
      ...
      category: "Plantation Crop",
      image:
        "https://images.unsplash.com/photo-1447933601403-0c6688de566e?w=200&h=200&fit=crop&crop=center",
    },
    {
      value: "cardamom",
      label: "Cardamom",
    ...
    },
    {
      ...
      category: "Nut",
      image:
        "https://images.unsplash.com/photo-1582899718505-cec84a45ee5a?w=200&h=200&fit=crop&crop=center",
    },
    {
      value: "jackfruit",
      label: "Jackfruit",
      category: "Fruit",
      image:
        "https://images.unsplash.com/photo-1577234286642-fc512a5f8f11?w=200&h=200&fit=crop&crop=center",
    },
    {
      value: "vanilla",
      label: "Vanilla",
  ...
  const recommendations = [
    {
      ...
      reasons:
        selectedLanguage === "english"
          ...
          : selectedLanguage === "hindi"
          ? [
              "आपकी भूमि के आकार के लिए उपयुक्त",
              "अच्छी पानी की उपलब्धता",
              "पिछला अनुभव",
              "पारिवारिक उपयोग",
            ]
          : [
              "നിങ്ങളുടെ ഭൂമിയുടെ വലുപ്പത്തിന് അനുയോജ്യം",
              "നല്ല വെള്ളം ലഭ്യത",
              "മുൻ അനുഭവം ഉണ്ട്",
              "കുടുംബത്തിന്റെ ഭക്ഷണത്തിന്",
            ],
    },
    {
      crop:
      ...
      expectedYield:
        selectedLanguage === "english"
          ? "60-80 nuts/tree/year"
          : selectedLanguage === "hindi"
          ? "60-80 नारियल/पेड़/साल"
          : "60-80 തേങ്ങ/വൃക്ഷം/വർഷം",
      ...
      reasons:
        selectedLanguage === "english"
          ...
          : [
              "ദീർഘകാല നിക്ഷേപം",
              "മിശ്ര കൃഷിക്ക് അനുയോജ്യം",
              "നല്ല മാർക്കറ്റ് ഡിമാന്റ്",
            ],
    },
    {
      crop:
                  ...
                  {currentStepData.questions.map((question, qIndex) => (
                    <div key={qIndex} className="space-y-6">
                      ...
                      {question.type === "radio" && (
                        <RadioGroup
                          value={
                            formData[question.field as keyof FormData] as string
                          }
                          onValueChange={(value) =>
                            setFormData((prev) => ({
                              ...prev,
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                {recommendations.map((rec, index) => (
                  <Card
                    key={index}
                    className={`${rec.color} border-2 shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden`}
                  >
                  ...
                  <div className="space-y-4 text-amber-800">
                    <div className="flex items-start gap-4 p-4 bg-white/60 rounded-xl">
                      ...
                      <div>
                        ...
                        <p className="text-sm">
                          {selectedLanguage === "english"
                            ? "Start planting in June-July for best results"
                            : selectedLanguage === "hindi"
                            ? "सर्वोत्तम परिणामों के लिए जून-जुलाई में रोपाई शुरू करें"
                    ...
                    <div className="flex items-start gap-4 p-4 bg-white/60 rounded-xl">
                      ...
                      <div>
                        ...
                        <p className="text-sm">
                          {selectedLanguage === "english"
                            ? "Plant once, harvest for 60+ years"
                            : selectedLanguage === "hindi"
                            ? "एक बार लगाएं, 60+ साल तक फसल लें"
                    ...
                    <div className="flex items-start gap-4 p-4 bg-white/60 rounded-xl">
                      ...
                      <div>
                        ...
                        <p className="text-sm">
                          {selectedLanguage === "english"
                            ? "Harvest in 9-12 months with good returns"
                            : selectedLanguage === "hindi"
                            ? "9-12 महीने में अच्छे रिटर्न के साथ फसल"
